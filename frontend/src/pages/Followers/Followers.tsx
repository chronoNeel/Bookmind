...
const Followers: React.FC = () => {
  ...
  // Generate mock followers data with random images
  useEffect(() => {
    const generateFollowers = () => {
      const mockFollowers: Follower[] = Array.from(
        { length: 32 },
        (_, index) => ({
          id: index + 1,
    ...
    const allFollowers = generateFollowers();
    setFollowers(allFollowers);
    setTotalPages(Math.ceil(allFollowers.length / itemsPerPage));
  }, []);

  // Get current page followers
  const getCurrentFollowers = () => {
    const startIndex = (currentPage - 1) * itemsPerPage;
    const endIndex = startIndex + itemsPerPage;
    return followers.slice(startIndex, endIndex);
  };
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-8">
              ...
              <div className="row g-3">
                {getCurrentFollowers().map((follower) => (
                  <div
                    key={follower.id}
                        ...
                        <button
                          ...
                          style={{
                            ...
                            backgroundColor: follower.isFollowing
                              ? "transparent"
                              : "#d97706",
                            color: follower.isFollowing ? "#d97706" : "white",
                          }}
                        >
              ...
              {followers.length === 0 && (
                <div className="text-center py-5">
                  ...
                  <h3 className="text-gray-600 mb-2">No followers yet</h3>
